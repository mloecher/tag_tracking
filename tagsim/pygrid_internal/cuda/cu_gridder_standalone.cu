...
extern "C" __global__
void grid2d(cfloat *data, float *kr, float *ki, float *traj, float *dens,
...
extern "C" __global__
void grid3d(cfloat *data, float *kr, float *ki, float *traj, float *dens,
            long n_points, long *N, float krad, long grid_mod, float *kernel)
{
    for (int i = blockIdx.x * blockDim.x + threadIdx.x; 
        i < n_points; 
...
extern "C" __global__
void igrid2d(cfloat *data, cfloat *kspace, float *traj, float *dens,
            long n_points, long *N, float krad, long grid_mod, float *kernel)
{
    for (int i = blockIdx.x * blockDim.x + threadIdx.x; 
        i < n_points; 
...
extern "C" __global__
void igrid3d(cfloat *data, cfloat *kspace, float *traj, float *dens,
            long n_points, long *N, float krad, long grid_mod, float *kernel)
{
    for (int i = blockIdx.x * blockDim.x + threadIdx.x; 
        i < n_points; 
...
extern "C" __global__
void deapp3(cfloat *A, long *N, float *D0, float *D1, float *D2) 
{
...
extern "C" __global__
void deapp2(cfloat *A, long *N, float *D0, float *D1) 
{
